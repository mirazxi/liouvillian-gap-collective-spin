...
def certify_k_vs_lowrank_box(
    ...
    # Bound on ||Im(L_k)|| over the box (using the top corner as in the working script family)
    ...
    # For 0.01 x 0.01 boxes this equals 0.01*k.
...
def main():
    ...
    out_csv = OUTPUT_DIR / "higher_rank_largek_adaptive_k81_to_k90.csv"
